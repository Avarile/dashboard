    ...
    <Layout style={{ minHeight: "100vh", backgroundColor: "white" }}>
      <Sider trigger={null} collapsible collapsed={uiController.collapsed} theme="light">
        ...
        <Menu theme="light" defaultSelectedKeys={["1"]} mode="inline">
          <Menu.Item key="1" icon={StyledCrownWrapper(CrownOutlined, { color: "red" })}>
            <Link to="/mainentrance/ordermanagment" style={{ textDecoration: "none" }}>
              订单管理
            </Link>
          </Menu.Item>
          <SubMenu key="sub1" icon={StyledCrownWrapper(CrownOutlined, { color: "blue" })} title="库存管理">
            ...
            <Menu.Item key="3" icon={<TabletOutlined />}>
              <Link to="/mainentrance/warehousing/currentStock?=mel" style={{ textDecoration: "none" }}>
                当前库存(Mel)
              </Link>
            </Menu.Item>
            <Menu.Item key="4" icon={<TabletOutlined />}>
              <Link to="/mainentrance/warehousing/currentStock?=bri" style={{ textDecoration: "none" }}>
                当前库存(Bri)
              </Link>
            </Menu.Item>
          </SubMenu>

          <SubMenu key="sub2" icon={StyledCrownWrapper(CrownOutlined, { color: "green" })} title="生产加工">
          ...
          <SubMenu key="sub3" icon={StyledCrownWrapper(CrownOutlined, { color: "brown" })} title="物流管理">
          ...
          <Menu.Item key="12" icon={StyledCrownWrapper(CrownOutlined, { color: "gold" })}>
